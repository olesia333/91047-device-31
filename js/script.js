const loginLink = document.querySelector(".write-me");
const loginPopup = document.querySelector(".modal-feedback");
const loginClose = loginPopup.querySelector(".modal-feedback-close");
const loginForm = loginPopup.querySelector(".feedback-form");
const loginLogin = loginPopup.querySelector(".feedback-name");
const loginEmail = loginPopup.querySelector(".feedback-mail");
